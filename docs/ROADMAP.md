...
## 0. Laboratory bootstrap — complete
...
## 1. First falsifiable memory experiment — supported in a scaffolded minimal family
...
## 4. Continual learning under a storage plateau
...
## 5. Adaptive computation and modular replacement
